                ...
                <div class="card-body">
                    ...
                    <div class="d-flex">
                        ...
                        <div id="recipe_cover">
                            ...
                            <img class="mr-4" style="position:relative;  width:150px; #888888 solid; border-radius:3%;"
                            src="{{asset($recipe->cover_link_md())}}">
                        ...
                        <div id="details">
                            ...
                            <button id="btn_edit" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#myModal" data-path="{{route('recipes.edit',['id'=>$recipe->id])}}"><i class="fas fa-trash"></i>&nbsp;Delete recipe</button>
...
$(document).ready(function(){
        ...
        $("#recipe_cover").on('click',function(){
